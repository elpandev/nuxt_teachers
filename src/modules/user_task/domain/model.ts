...
export class UserTask extends BaseModel<IUserTask> {
  ...
  public task_users_count: number             = 0
  ...
  public fromPayload(data?: Partial<IUserTask> | undefined): this {
    if (data) {
      ...
      if (data.task_users_count !== undefined) this.task_users_count = data.task_users_count
  ...
  public toPayload(): Partial<IUserTask> {
    return {
      ...
      task_users_count: this.task_users_count,
