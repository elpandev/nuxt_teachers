...
interface IScheduleFilter extends IBaseFilter {
  name?:           string
  student_id?:     string
  students_count?: number
}

export class ScheduleFilter extends BaseFilter implements IScheduleFilter {
  public name?:           string
  public student_id?:     string
  public students_count?: number

  constructor(data?: Partial<IScheduleFilter>) {
    super(data)
